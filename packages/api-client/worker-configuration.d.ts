/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 12aa0a44bdb77674f5a10e57b5aeb955)
// Runtime types generated with workerd@1.20260301.1 2026-01-26 nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		STORAGE: R2Bucket;
		DB: D1Database;
		NOTIFICATIONS_EMAIL_QUEUE: Queue;
		NOTIFICATIONS_SMS_QUEUE: Queue;
		RATE_LIMITER: RateLimit;
		BROWSER: Fetcher;
		APP_URL: "https://tools.ronald.it.com";
		BETTER_AUTH_URL: "https://tools-api.ronald.it.com";
		CORS_ORIGINS: "https://tools.ronald.it.com";
		R2_ACCOUNT_ID: "35ade4713beefb2c7f971921950b34c2";
		R2_BUCKET_NAME: "rnld-tools-prod";
	...
	interface Env {
		...
		RATE_LIMITER: RateLimit;
		BROWSER: Fetcher;
		APP_URL: "https://tools.ronald.it.com" | "http://localhost:3010";
		BETTER_AUTH_URL: "https://tools-api.ronald.it.com" | "http://localhost:3000";
		CORS_ORIGINS: "https://tools.ronald.it.com" | "http://localhost:3010";
		R2_ACCOUNT_ID: "35ade4713beefb2c7f971921950b34c2";
		R2_BUCKET_NAME: "rnld-tools-prod" | "rnld-tools-dev";
		R2_PRESIGNED_URL_TTL_SECONDS: "900";
		BETTER_AUTH_SECRET: string;
		SEED_TOKEN: string;
		SUPERADMIN_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "BETTER_AUTH_URL" | "CORS_ORIGINS" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_PRESIGNED_URL_TTL_SECONDS" | "BETTER_AUTH_SECRET" | "SEED_TOKEN" | "SUPERADMIN_PASSWORD" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "BREVO_API_KEY" | "BREVO_SENDER_EMAIL" | "BREVO_SENDER_NAME" | "PHILSMS_API_TOKEN" | "PHILSMS_SENDER_ID" | "SEMAPHORE_API_KEY" | "HTTPSMS_API_KEY" | "HTTPSMS_FROM">> {}
}
