    ...
    <BasicLayout>
      <div className="relative min-h-screen overflow-hidden bg-background">
        <div aria-hidden="true" className="absolute inset-0">
          ...
          <div className="absolute bottom-[-3rem] right-[-1rem] h-56 w-56 rounded-full bg-muted/80 blur-3xl" />
        ...
        <div className="relative flex min-h-screen items-center justify-center px-4 py-10 sm:px-6">
          <div className="relative w-full max-w-md">
            ...
            <Card className="relative w-full overflow-hidden border border-border/70 bg-background/85 py-0 shadow-[0_28px_90px_-42px_rgba(15,23,42,0.38)] backdrop-blur-xl dark:shadow-[0_32px_100px_-46px_rgba(0,0,0,0.65)]">
              ...
              <div
                  aria-hidden="true"
                  className="absolute inset-x-0 top-0 h-28 bg-gradient-to-b from-primary/[0.09] via-primary/[0.03] to-transparent"
              />
