...
export function AuthenticatedListPageShell({
  ...
  return (
    <div className="min-h-full bg-muted/[0.18]">
      <div className={cn('mx-auto flex w-full max-w-[1440px] flex-col px-3 py-3 sm:px-6 sm:py-5', className)}>
        <section className="overflow-hidden rounded-xl border border-border/80 bg-background/95 shadow-sm shadow-black/[0.03]">
          <div className="flex flex-col gap-4 px-3 py-3 sm:px-5 sm:py-5 lg:flex-row lg:items-center lg:justify-between">
