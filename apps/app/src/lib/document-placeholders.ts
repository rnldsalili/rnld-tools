...
export const LOAN_DOCUMENT_PLACEHOLDERS: Array<LoanDocumentPlaceholderDefinition> = [
  ...
  { key: '{{loan.borrower}}', label: 'Client Name', isBlock: false },
  { key: '{{loan.email}}', label: 'Client Email', isBlock: false },
  { key: '{{loan.phone}}', label: 'Client Phone', isBlock: false },
  { key: '{{loan.address}}', label: 'Client Address', isBlock: false },
  ...
  { key: LOAN_DOCUMENT_SIGNATURE_PLACEHOLDER, label: 'Client Signature', isBlock: true },
];
