...
INSERT INTO "new_loan_installment" ("createdAt", "createdByUserId", "dueDate", "id", "loanId", "remarks", "status", "updatedAt", "updatedByUserId") SELECT "createdAt", "createdByUserId", "dueDate", "id", "loanId", "remarks", "status", "updatedAt", "updatedByUserId" FROM "loan_installment";
