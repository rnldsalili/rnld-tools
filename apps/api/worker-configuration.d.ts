/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b599be3b237f7e9e9ccd3e70f00fde15)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		BETTER_AUTH_URL: "YOUR_API_URL";
		CORS_ORIGINS: "YOUR_ADMIN_URL";
	...
	interface Env {
		DB: D1Database;
		RATE_LIMITER: RateLimit;
		BETTER_AUTH_URL: "YOUR_API_URL" | "http://localhost:3000";
		CORS_ORIGINS: "YOUR_ADMIN_URL" | "http://localhost:3010";
		BETTER_AUTH_SECRET: string;
		R2_ACCESS_KEY_ID: string;
		R2_SECRET_ACCESS_KEY: string;
		SEED_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CORS_ORIGINS" | "BETTER_AUTH_SECRET" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "SEED_TOKEN">> {}
}
